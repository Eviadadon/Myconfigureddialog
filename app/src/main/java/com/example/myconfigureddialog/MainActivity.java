...
/**
 * main activity, at this activity  you have 4 buttons to choose, every one has different act
 */
public class MainActivity extends AppCompatActivity {
    ...
    /**
     *  i can return/move to credit activity
     *
     * @param menu
     * @return
     */
    public boolean onOptionsItemSelected(MenuItem menu) {
        ...
        if ((st.equals("credits"))) {
            Intent si = new Intent(this, creditssss.class);
            startActivity(si);
        }
    ...
    /**
     * pick color and draw the screen with the choices color
     * @param view
     */
    ...
    /**
     * the screen will be change to the one or many color you had chose
     * @param view
     */
    public void secend(View view) {
        adb2 =new AlertDialog.Builder(this);
        adb2.setTitle("Try mix the colors ");
